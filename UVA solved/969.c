...
void clearTree(node *tree){
	if ( tree->left != 0 ) clearTree(tree->left);
	if ( tree->right != 0 ) clearTree(tree->right);
	free(tree);
}
...
void optimizeTree(node *tree){
	...
	if ( tree->left ) optimizeTree(tree->left);
	if ( tree->right ) optimizeTree(tree->right);
